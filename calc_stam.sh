        ...
        for param in 0.1 0.01 0.2 0.3 0.4 0.5 0.05 0.6 0.7 0.8 0.9 1.0; do
            ...
            #for lang in swa; do
                for seed in 1 2 3; do
                    ...
                    #P=$((D+seed))
                    #D=$((P % 2))
                    CUDA_VISIBLE_DEVICES=$D ./run.sh scripts/get_entropies.py --model_type $model --corruption_name $corruption --param $param --language $lang --number_of_predictions 50 --seed $seed &
                count=$((count+1))
