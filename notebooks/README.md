This folder contains the notebooks used to preprocess the various datasets and train different models as well as extracting the results from the saved models to display them as plots.
